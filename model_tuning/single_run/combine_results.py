...
for model in models:
    ...
    outpath = '../../results/model_tuning_combined_results/single_trial/'
    if os.path.isdir(outpath) is False:
        os.makedirs(outpath)
    concat_df.to_csv("../../results/model_tuning_combined_results/single_trial/{}.csv".format(model), index=False)
