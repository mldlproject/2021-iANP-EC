...
#============================================================
# Load data
train_md      = np.load("../../data/singlerun/featurised_data/rdkit_md_train.npy")
train_mf1024  = np.load("../../data/singlerun/featurised_data/fp1024_train.npy")
train_mf2048  = np.load("../../data/singlerun/featurised_data/fp2048_train.npy")
train_mol2vec = np.load("../../data/singlerun/featurised_data/mol2vec_train.npy")
train_label   = np.load("../../data/singlerun/featurised_data/label_train.npy")

val_md        = np.load("../../data/singlerun/featurised_data/rdkit_md_val.npy")
val_mf1024    = np.load("../../data/singlerun/featurised_data/fp1024_val.npy")
val_mf2048    = np.load("../../data/singlerun/featurised_data/fp2048_val.npy")
val_mol2vec   = np.load("../../data/singlerun/featurised_data/mol2vec_val.npy")
val_label     = np.load("../../data/singlerun/featurised_data/label_val.npy")

test_md       = np.load("../../data/singlerun/featurised_data/rdkit_md_test.npy")
test_mf1024   = np.load("../../data/singlerun/featurised_data/fp1024_test.npy")
test_mf2048   = np.load("../../data/singlerun/featurised_data/fp2048_test.npy")
test_mol2vec  = np.load("../../data/singlerun/featurised_data/mol2vec_test.npy")
test_label    = np.load("../../data/singlerun/featurised_data/label_test.npy")
