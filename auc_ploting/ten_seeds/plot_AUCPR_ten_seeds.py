...
for i in range(len(feature_list)):
    df = pd.read_csv("../result/ten_seeds/combined_pred_{}_{}_ten_seeds.csv".format(learning_algorithm[i].lower(), feature_list[i]), encoding='utf-8')
    true_class = pd.DataFrame(np.load("../data/ten_seeds/seed_0/featurised_data/label_test.npy"))
