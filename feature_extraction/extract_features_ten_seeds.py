...
for i in range(10):
    ...
    for dataset in datasets:
        data  = pd.read_csv("../data/ten_seeds/seed_{}/original_data/data_{}.csv".format(i, dataset))['Smiles'].to_list()
        label = pd.read_csv("../data/ten_seeds/seed_{}/original_data/data_{}.csv".format(i, dataset))['label']
